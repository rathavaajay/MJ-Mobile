                        ...
                        <div class="carousel-item active">
                           <div class="container">
                              <div class="carousel-caption ">
                                 <div class="row">
                                    <div class="col-md-12">
                                          <figure><img src="images/img18.png" alt="#" width="500px"/></figure>
               ...
               <div class="col-md-6">
                  <form id="request" class="main_form" method="post">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12 ">
                          Product Name:- <input class="contactus" type="type" name="Iphone_name"value="Apple iPhone 12 (128GB, Starlight White)"> 
                        </div>
                        <div class="col-md-12">
                           Product Price:-<input class="contactus" type="type" name="Price" value="45,000"> 
                        </div>
                        <div class="col-md-12">
