               ...
               <div class="col-md-6">
                  <form id="request" class="main_form" method="post">
                     <?php
                        ...
                        $q="insert into feedback(Id,Name,Phone_number,Email,Message)values('NULL','".$_POST['Name']."','".$_POST['Phone_number']."','".$_POST['Email']."','".$_POST['message']."')";
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <button class="send_btn" type="submit" name="ok">Send</button>
                        </div>
                     </div>
                  </form>
               </div>
