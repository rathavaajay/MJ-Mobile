                        ...
                        <div class="carousel-item active">
                           <div class="container">
                              <div class="carousel-caption ">
                                 <div class="row">
                                    <div class="col-md-12">
                                          <figure><img src="images/img7.png" alt="#" width="500px"/></figure>
         ...
         <div class="row">
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                 <div class="glasses_box">
                    ...
                    <h3><span class="blu"></span>35,000.00 <h7>35,000.00</h7></h3>
                  </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                 <div class="glasses_box">
               ...
               <div class="col-md-6">
                  <form id="request" class="main_form" method="post">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12 ">
                          Product Name:- <input class="contactus" type="type" name="Iphone_name"value="Apple iPhone 11 Mini (64GB, Black)"> 
                        </div>
                        <div class="col-md-12">
                           Product Price:-<input class="contactus" type="type" name="Price" value="35,000"> 
                        </div>
                        <div class="col-md-12">
