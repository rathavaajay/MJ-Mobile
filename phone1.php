                        ...
                        <div class="carousel-item active">
                           <div class="container">
                              <div class="carousel-caption ">
                                 <div class="row">
                                    <div class="col-md-12">
                                          <figure><img src="images/imge.png" alt="#" width="500px"/></figure>
                        ...
                        <div class="carousel-item">
                           <div class="container">
                              <div class="carousel-caption">
                                 <div class="row">
                                    <div class="col-md-12">
                                          <figure><img src="images/imge1.png" alt="#"width="500px"/></figure>
                        ...
                        <div class="carousel-item">
                           <div class="container">
                              <div class="carousel-caption">
                                 <div class="row">
                                    <div class="col-md-12">
                                          <figure><img src="images/imge2.jpg" alt="#"width="500px"/></figure>
         ...
         <div class="row">
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                 <div class="glasses_box">
                    <a href="Phones.php"> <figure><img src="images/imge.png" alt="#"/></figure></a>
                     <p>Apple iPhone 14 (128 GB, red)</p>
                    <h3><span class="blu"></span>79,900.00 <h7>80,900.00</h7></h3>
                  </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                 <div class="glasses_box">
               ...
               <div class="col-md-6">
                  <form id="request" class="main_form" method="post">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12 ">
                          Product Name:- <input class="contactus" type="type" name="Iphone_name"value="<?php echo $row['pro_name'];?>"> 
                        </div>
                        <div class="col-md-12">
                           Product Price:-<input class="contactus" placeholder="79,000.00" type="type" name="Price" value="<?php echo $row['pro_price'];?>"> 
                        </div>
                        <div class="col-md-12">
