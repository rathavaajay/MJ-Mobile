  ...
  if(isset($_POST["ok"]))
			   {
					include('connection.php');
						...
						$q="insert into product(id,pro_name,pro_price,Company,Quantity,Product_status,photo)values(NULL,'".$_POST['productname']."','".$_POST['price']."','".$_POST['company']."','".$_POST['Quantity']."','".$_POST['Product_status']."','$p')";
...
<table align="center" border="1" cellpadding="10" cellspacing="10">
	  ...
	  <tr>
				...
				<td align="center" valign="top">
             	<input type="text" name="company" placeholder="company"  size="50" />
				</td>
	  ...
	  <tr>
				...
				<td align="center" valign="top">
						<input type="text" name="Quantity" placeholder="Quantity"  size="50"  />
				</td>
