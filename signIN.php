...
<html lang="en">
   ...
   <body class="main-layout position_head">
    ...
    echo "<script>window.location='login.php'</script>";
                           echo "<script>window.location='ones.php'</script>";
                       }
                                                  ?>
                     <div class="row">
                        <div class="col-md-12 ">
                        ...
                        <div class="col-md-12">
                           <input class="contactusmess" placeholder="Repeat Your Password" type="type" Message="Name" name="re_pass">
                        </div>
                        <div class="col-md-12">
                           <button class="send_btn" type="submit" name="ok">signin</button>
                        </div>
                     </div>
                  </form>
               </div>
